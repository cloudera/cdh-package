...
Requires: avro-libs, parquet, sentry >= 1.3.0+cdh5.1.4-SNAPSHOT, solr >= 4.4.0+cdh5.1.4-SNAPSHOT, kite >= 0.10.0+cdh5.1.4-SNAPSHOT, hbase, hadoop-hdfs, hadoop, zookeeper, avro-libs
