...
Requires: avro-libs, parquet, sentry >= 1.3.0+cdh5.1.1-SNAPSHOT, solr >= 4.4.0+cdh5.1.1-SNAPSHOT, kite >= 0.10.0+cdh5.1.1-SNAPSHOT, hbase, hadoop-hdfs, hadoop, zookeeper, avro-libs
