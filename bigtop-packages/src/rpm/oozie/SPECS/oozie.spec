...
Requires: avro-libs, parquet, zookeeper, hadoop, hadoop-hdfs, hadoop-mapreduce, hadoop-yarn, hive >= 0.12.0+cdh5.1.2, hive-hcatalog >= 0.12.0+cdh5.1.2, hive-webhcat >= 0.12.0+cdh5.1.2
BuildArch: noarch
