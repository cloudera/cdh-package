...
%define tomcat_conf_solr %{etc_solr}/tomcat-conf
...
Requires: hadoop, hadoop-hdfs, sentry >= 1.3.0+cdh5.1.3-SNAPSHOT, zookeeper
...
sh $RPM_SOURCE_DIR/install_solr.sh \
          --build-dir=solr/build/solr-%{solr_patched_version} \
