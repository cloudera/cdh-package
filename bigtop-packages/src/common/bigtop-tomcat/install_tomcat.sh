...
cp -r $BUILD_DIR/work $LIB_DIR/work
cp -r $BUILD_DIR/temp $LIB_DIR/temp
cp -r $BUILD_DIR/logs $LIB_DIR/logs
cp -r $BUILD_DIR/lib  $LIB_DIR/lib
cp -r $BUILD_DIR/conf $LIB_DIR/conf.template
cp -r $BUILD_DIR/bin  $LIB_DIR/bin

install -d -m 0755 $DOC_DIR
cp $BUILD_DIR/{RUNNING.txt,RELEASE-NOTES,NOTICE,LICENSE} $DOC_DIR
