...
out_file=debian/hadoop-0.20-mapreduce/usr/share/doc/hadoop-0.20/copyright

for license in `find debian/hadoop-0.20-mapreduce/usr/lib/hadoop-0.20/ -name \*LICENSE.txt` ; do
    (echo
     echo -------------
